...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        if (HTML5_DEBUG) {
            ...
            wp_register_script('jquery', get_template_directory_uri() . '/bower_components/jquery/dist/jquery.js', array());
...
{
    register_taxonomy_for_object_type('category', 'downloads'); // Register Taxonomies for Category
...
// Muda nome do Posts para Notícias
function revcon_change_post_label() {
    ...
    $submenu['edit.php'][16][0] = 'Etiquetas de Notícias';
    echo '';
}
function revcon_change_post_object() {
    ...
    $labels->not_found_in_trash = 'Nenhuma Notícia encontrado na lixeira';
...
function create_post_type_videos()
{
    ...
    register_post_type('videos', // Register Custom Post Type
        ...
        'labels' => array(
            ...
            'add_new' => __('Adicionar', 'videos'),
            'add_new_item' => __('Adicionar novo Video', 'videos'),
            'edit' => __('Editar', 'videos'),
            'edit_item' => __('Editar Video', 'videos'),
            'new_item' => __('Novo Video', 'videos'),
            'view' => __('Ver Video', 'videos'),
            'view_item' => __('Ver Video', 'videos'),
            'search_items' => __('Procurar Video', 'videos'),
            'not_found' => __('nenhum Video encontrado', 'videos'),
            'not_found_in_trash' => __('nenhum videos encontrados na lixeira', 'videos')
        ),
        'public' => true,
        'hierarchical' => true, // Allows your posts to behave like Hierarchy Pages
        'has_archive' => true,
